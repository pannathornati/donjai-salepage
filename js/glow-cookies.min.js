...
class GlowCookies {
    constructor() {
        ...
        this.PreBanner = void 0,
        this.Cookies = void 0,
        this.DOMbanner = void 0
    }
    render() {
        this.addCss(),
    ...
    addCss() {
        ...
        e.setAttribute("href", "https://cdn.jsdelivr.net/gh/manucaralmo/GlowCookies@3.1.3/src/glowCookies.min.css"),
        document.head.appendChild(e)
    }
    createDOMElements() {
        this.PreBanner = document.createElement("div"),
        this.PreBanner.innerHTML = `<button type="button" id="prebannerBtn" class="prebanner prebanner__border__${
            this.config.bannerStyle
        } glowCookies__${
            this.config.position
        } glowCookies__${
            this.config.border
        } animation" style="color: ${
            this.banner.manageCookies.color
        }; background-color: ${
            this.banner.manageCookies.background
        ...
        this.Cookies.innerHTML = `<div \n                                    id="glowCookies-banner" \n                                    class="glowCookies__banner glowCookies__banner__${
            this.config.bannerStyle
        } glowCookies__${
            this.config.border
        } glowCookies__${
        ...
        }\n                                        </a>\n                                    </p>\n                                    <div class="btn__section">\n                                        <button type="button" id="acceptCookies" class="btn__accept accept__btn__styles" style="color: ${
            this.banner.acceptBtn.color
        }; background-color: ${
            this.banner.acceptBtn.background
        };">\n                                            ${
            this.banner.acceptBtn.text
        }\n                                        </button>\n                                        <button type="button" id="rejectCookies" class="btn__settings settings__btn__styles" style="color: ${
            this.banner.rejectBtn.color
        }; background-color: ${
            this.banner.rejectBtn.background
        };">\n                                            ${
    ...
    activateTracking() {
        if (this.tracking.AnalyticsCode) {
            ...
            e.setAttribute("src", `https://www.googletagmanager.com/gtag/js?id=${
                this.tracking.AnalyticsCode
            }`),
            document.head.appendChild(e);
        ...
        if (this.tracking.FacebookPixelCode) {
            ...
            e.text = `\n                                    !function(f,b,e,v,n,t,s)\n                                    {if(f.fbq)return;n=f.fbq=function(){n.callMethod?\n                                    n.callMethod.apply(n,arguments):n.queue.push(arguments)};\n                                    if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';\n                                    n.queue=[];t=b.createElement(e);t.async=!0;\n                                    t.src=v;s=b.getElementsByTagName(e)[0];\n                                    s.parentNode.insertBefore(t,s)}(window, document,'script',\n                                    'https://connect.facebook.net/en_US/fbevents.js');\n                                    fbq('init', '${
                this.tracking.FacebookPixelCode
            }');\n                                    fbq('track', 'PageView');\n                                `,
            document.head.appendChild(e);
            ...
            n.setAttribute("src", `https://www.facebook.com/tr?id=${
                this.tracking.FacebookPixelCode
        ...
        if (this.tracking.HotjarTrackingCode) {
            ...
            e.text = `\n                                (function(h,o,t,j,a,r){\n                                    h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};\n                                    h._hjSettings={hjid:${
                this.tracking.HotjarTrackingCode
    ...
    clearCookies() {
        ...
        for (let n = 0; n < e.length; n++) {
            ...
            for (; t.length > 0;) {
                ...
                for (document.cookie = o + "/"; a.length > 0;) 
                    document.cookie = o + a.join("/"),
                    a.pop();
